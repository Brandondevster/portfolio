    ...
    <div name="home" className="w-full h-screen bg-[#000000]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full text-gray-300">
        ...
        <p className="text-lg text-[#eeeeee] py-4 max-w-[700px]">
          I specialize in creating and building web applications from front end to back end. When building these
          full stack web applications, I focus on curating an interactive and functional
          experience.
        </p>
